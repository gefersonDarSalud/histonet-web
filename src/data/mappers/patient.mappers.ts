import type { Business, Mapper, Patient, PatientContracts, PatientFull } from "#/core/entities";
import type { PatientApiDto, PatientBusinessApiDto, PatientContractsApiDto, PatientFullApiDto } from "#/utils/types";
