...
export class ServiceContainer {
    ...
    public readonly getPatientRelationshipName: GetPatientRelationshipNameService;
    ...
    constructor() {
        ...
        this.getPatientRelationshipName = new GetPatientRelationshipNameService(this.repository.patient);
